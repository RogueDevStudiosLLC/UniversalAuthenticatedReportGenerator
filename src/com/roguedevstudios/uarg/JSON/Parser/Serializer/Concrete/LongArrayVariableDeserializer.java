...
*   File Name: 								*
*   LongArrayVariableDeserializer.java 	*
*                            	   	    	*
*   Deserializes JSON						*
...
public class LongArrayVariableDeserializer implements JsonDeserializer<IVariable<Long[]>> {
	...
	public IVariable<Long[]> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		if(o.has("Value")) {
			...
			while(it.hasNext()) {
				_value[counter] = it.next().getAsLong();
				counter++;
			}
		}
